    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body card-block">
                <form action="{{url('admin/save-tag')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="text" id="slug" onkeyup="ChangeToSlug();" name="tag_name" placeholder="Text" class="form-control">
