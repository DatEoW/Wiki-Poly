...
<head>
    ...
    <script src="{{ asset('assets/js/convert-slug.js')}}"></script>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('major.index') }}">Danh sách</a>
                        <a class="collapse-item" href="{{ route('major.create')}}">Thêm mới</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Danh sách</h6>
                        <a class="collapse-item" href="{{ route('majorC.index') }}">Danh sách</a>
                        <a class="collapse-item" href="{{ route('majorC.create') }}">Thêm mới</a>
                    </div>
                </div>
            </li>
